...
export const register = (req, res) => {
  ...
  db.query(q, [req.body.email, req.body.username], (err, data) => {
    ...
    const values = [req.body.username, req.body.email, hash, "https://res.cloudinary.com/codenipun/image/upload/v1717007971/neijttnbcug7edb2nkcl.png"];
...
export const login = (req, res) => {
  ...
  const q = isEmail ? "SELECT * FROM users WHERE email=?" : "SELECT * FROM users WHERE username=?";
